...
Free whatsapp api that you can install on your own server and run in less than 5 minutes!
...
- [Quick start](#quick-start)
  ...
  * [Send your first message](#send-your-first-message)
    ...
    + [2. Run WhatsApp HTTP API](#2-run-wa-hooks-api)
...
```bash
docker pull devlikeapro/wa-hooks-api
```
...
docker pull devlikeapro/wa-hooks-api-plus
docker logout
```
...
```bash
docker run -it --rm -p 3000:3000/tcp --name wa-hooks-api devlikeapro/wa-hooks-api
